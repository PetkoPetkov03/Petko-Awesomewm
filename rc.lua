...
local taglist_buttons = awful.util.table.join(awful.button({}, 1, function(t)
    t:view_only()
...
clientkeys = awful.util.table.join(awful.key({modkey}, "f", function(c)
...
awful.util.spawn("xrandr --output HDMI-1 --mode 1920x1080 --rate 60")
